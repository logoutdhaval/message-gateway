...
public class DataSourcePerTenantService implements DisposableBean {
    ...
    @Value("${operationsmysql.datasource.core.port}")
    private int defaultPort;

    @Value("${operationsmysql.datasource.core.host}")
    private String defaultHostname;

    @Value("${operationsmysql.datasource.core.schema}")
    private String defaultSchema;

    @Value("${operationsmysql.datasource.core.username}")
    private String defaultUsername;

    @Value("${operationsmysql.datasource.core.password}")
    private String defaultPassword;

    @Value("${operationsmysql.datasource.common.protocol}")
    private String jdbcProtocol;

    @Value("${operationsmysql.datasource.common.subprotocol}")
    private String jdbcSubprotocol;

    @Value("${operationsmysql.datasource.common.driverclass_name}")
